...
#include "../ProjetCPP/simulationwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SimulationWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 26, 15), // "open_simulation"
QT_MOC_LITERAL(4, 42, 7), // "disable"
QT_MOC_LITERAL(5, 50, 15) // "change_position"

    },
    "SimulationWindow\0message\0\0open_simulation\0"
    "disable\0change_position"
};
...
void SimulationWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SimulationWindow *_t = static_cast<SimulationWindow *>(_o);
        switch (_id) {
        case 0: _t->message(); break;
        case 1: _t->open_simulation(); break;
        case 2: _t->disable((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->change_position((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *SimulationWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SimulationWindow.stringdata))
